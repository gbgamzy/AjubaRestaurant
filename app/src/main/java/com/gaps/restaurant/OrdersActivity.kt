...
import com.gaps.restaurant.classes.AdapterInterface
import com.gaps.restaurant.classes.Food
import com.gaps.restaurant.classes.Order
import com.gaps.restaurant.classes.OrderAdapter
...
class OrdersActivity : AppCompatActivity(), AdapterInterface {
    ...
    override fun addToCartFromMenu(c: Food) {
        TODO("Not yet implemented")
    }

    override fun removeFromCartFromMenu(c: Food) {
        TODO("Not yet implemented")
    }
}